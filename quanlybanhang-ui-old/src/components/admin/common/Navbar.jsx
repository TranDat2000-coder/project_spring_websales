        ...
        <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div className="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
                ...
                <ul className="navbar-nav navbar-nav-right ml-auto">
                    <form className="search-form d-none d-md-block" action="" method="POST">
                        <i className="icon-magnifier"></i>
                        <input type="search" name="keyword" className="form-control" placeholder="Search Here" title="Search here" />
                    </form>
